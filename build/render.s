...
.Lfunc_end1:
	.size	_ZN12PitchShifterD2Ev, .Lfunc_end1-_ZN12PitchShifterD2Ev
	.fnend
...
.LBB2_2:
	...
	strlo	r1, [r4, #20]
.LBB2_3:                                @ %_ZNSt6vectorIfSaIfEE6resizeEj.exit
	ldr	r1, [r4, #28]
	ldr	r2, [r4, #32]
	sub	r3, r2, r1
	asr	r2, r3, #2
...
.LBB2_5:
	...
	strlo	r1, [r4, #32]
.LBB2_6:                                @ %_ZNSt6vectorIfSaIfEE6resizeEj.exit2
	ldrd	r2, r3, [r4, #40]
	sub	r3, r3, r2
	asr	r1, r3, #2
	cmp	r0, r3, asr #2
...
.LBB2_8:
	...
	addlo	r1, r2, r0, lsl #2
	strlo	r1, [r4, #44]
.LBB2_9:                                @ %_ZNSt6vectorIfSaIfEE6resizeEj.exit3
	ldr	r1, [r4, #52]
	ldr	r2, [r4, #56]
	sub	r3, r2, r1
	asr	r2, r3, #2
...
.LBB2_11:
	...
	addlo	r1, r1, r0, lsl #2
	strlo	r1, [r4, #56]
.LBB2_12:                               @ %_ZNSt6vectorIfSaIfEE6resizeEj.exit4
	ldrd	r2, r3, [r4, #64]
	sub	r3, r3, r2
	asr	r1, r3, #2
	cmp	r0, r3, asr #2
...
.LBB2_14:
	...
	strlo	r0, [r4, #68]
.LBB2_15:                               @ %_ZNSt6vectorIfSaIfEE6resizeEj.exit5
	mov	r0, #1
	sub	sp, r11, #8
	pop	{r4, r10, r11, pc}
.Lfunc_end2:
...
@ BB#5:                                 @ %_ZNSt16allocator_traitsISaIfEE8allocateERS0_j.exit.i
	...
	ldm	r4, {r1, r7}
	mov	r6, r0
.LBB5_6:                                @ %_ZNSt12_Vector_baseIfSaIfEE11_M_allocateEj.exit
	sub	r2, r7, r1
	mov	r0, #0
	asr	r7, r2, #2
	cmp	r0, r2, asr #2
...
@ BB#9:
	bl	_ZdlPv
.LBB5_10:                               @ %_ZNSt12_Vector_baseIfSaIfEE13_M_deallocateEPfj.exit31
	str	r6, [r4]
	add	r0, r6, r8, lsl #2
	str	r5, [r4, #4]
	str	r0, [r4, #8]
...
.LBB5_12:                               @ %_ZSt27__uninitialized_default_n_aIPfjfET_S1_T0_RSaIT1_E.exit
	lsl	r2, r5, #2
	mov	r0, r7
	mov	r1, #0
	bl	memset
...
.Lfunc_end5:
	.size	_ZNSt6vectorIfSaIfEE17_M_default_appendEj, .Lfunc_end5-_ZNSt6vectorIfSaIfEE17_M_default_appendEj
	.fnend
